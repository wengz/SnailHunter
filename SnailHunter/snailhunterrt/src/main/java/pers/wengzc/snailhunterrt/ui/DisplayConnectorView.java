...
public final class DisplayConnectorView extends View {
    ...
    static {
        iconPaint.setColor(CanaryUi.LIGHT_GREY);
        rootPaint.setColor(CanaryUi.ROOT_COLOR);
        leakPaint.setColor(CanaryUi.LEAK_COLOR);
        clearPaint.setColor(Color.TRANSPARENT);
        clearPaint.setXfermode(CanaryUi.CLEAR_XFER_MODE);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (cache == null) {
            ...
            float strokeSize = CanaryUi.dpToPixel(4f, getResources());
